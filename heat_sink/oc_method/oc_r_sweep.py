...
def main():
    ...
    parser.add_argument("--mesh-dim", type=int, default=256)
    parser.add_argument("--r-start", type=float, default=3.794)
    parser.add_argument("--r-end", type=float, default=3.794)
